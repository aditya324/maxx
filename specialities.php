...
<body class="bg-surface-soft font-sans">
 ...
 <section class="w-full h-screen pt-28 ">
  ...
  <section class="w-full py-10 ">
    ...
    <!-- ============ SPECIALITIES (icon grid) ============ -->
    <!-- ============ SPECIALITIES (updated with your list) ============ -->
    <div
      id="specialities"
      class="tab-content show grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-3 gap-5 lg:gap-10 justify-items-center grid-cols-1 mt-6 px-4">

      <!-- 1. Anaesthesia -->
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Invasive & Non-Invasive Cardiology</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Cardiac Thoracic Surgery</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Critical Care Medicine</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Emergency Medicine</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Endocrine Surgery</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">General Medicine</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">General & Laparoscopic Surgery</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Interventional Radiology</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Surgical Gastroenterology</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Oral & Maxillo Facial Surgery</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Nephrology & Dialysis</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Ophthalmology</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Orthopedics & Joint Replacement</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Obstetrics & Gynecology</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[18px] font-semibold text-[#5c2c20] text-center">Pediatric Surgery</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Plastic Surgery</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Pulmonology</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        data-name="Pathology">
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Pathology</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[17px] font-semibold text-[#5c2c20] text-center">Physiotherapy & Rehabilitation</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Psychiatry (OPD Only)</h3>
      </div>
      ...
      <div class="speciality-card card-hover w-[241px] h-[226px] bg-white rounded-[20px] shadow-md flex flex-col items-center justify-center"
        ...
        <img src="./assets/icons/heart.png" class="w-20 h-20 mb-3" />
        <h3 class="text-[20px] font-semibold text-[#5c2c20] text-center">Radiology & Imaging</h3>
      </div>
    ...
    <!-- ============ DIAGNOSTICS (placeholder using your style) ============ -->
    <div
      id="diagnostics"
      class="tab-content show grid xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-3 gap-5 lg:gap-10 justify-items-center grid-cols-1 mt-6 px-4">
