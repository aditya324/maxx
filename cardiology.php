      ...
      <div class="order-2 md:order-1 px-6 py-8 md:px-10 md:py-10">
        ...
        <ul class="space-y-3 md:space-y-3.5 text-[15px] md:text-2xl leading-5 font-semibold ">
          <li class="flex items-start gap-3">
            <span
              class="mt-1 h-6 w-6 flex items-center justify-center rounded-full bg-[#7B3F34] text-white text-xs shrink-0"
              >✓</span
            >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            ...
            <div class="border border-[#FEAE01] rounded-lg bg-white">
              ...
              >
                <span class="text-gray-700 text-xl font-semibold"
                  >What is the Digital Marketing Masterclass?</span
                >
            ...
            <div class="border border-[#FEAE01] rounded-lg bg-white">
              ...
              >
                ...
                >
                <span
                  class="w-7 h-7 border border-[#FEAE01] rounded-full flex items-center justify-center text-[#FEAE01] font-bold"
                  >+</span
                >
              </button>
              <div class="hidden px-5 pb-4 text-gray-600 text-sm">
          ...
          <div class="space-y-4">
            <div class="border border-[#FEAE01] rounded-lg bg-white">
              ...
              >
                <span class="text-gray-700 text-xl font-semibold"
                  >What if I miss a Live Class?</span
                >
                <span
                  class="w-7 h-7 border border-[#FEAE01] rounded-full flex items-center justify-center text-[#FEAE01] font-bold"
                  >+</span
