        ...
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold text-[#6C3130] leading-tight">
                    Overview
                    <span class="text-[#ec8b2a]">General & Keyhole Surgery</span>
                </h1>
                ...
                <div class="space-y-2">
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Appendectomy –</strong> Surgical removal of an inflamed appendix.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Hernia Repair –</strong> Open and laparoscopic hernia repair techniques.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Gallbladder Surgery –</strong> Laparoscopic cholecystectomy for gallstone disease.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Bowel Surgery –</strong> Resection procedures for cancer, obstruction, or intestinal disease.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Thyroid & Parathyroid Surgery –</strong> Surgical management of nodules, tumors, and gland disorders.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Breast Surgery –</strong> Lumpectomy, mastectomy, and reconstructive procedures.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Minimally Invasive Surgery –</strong> Keyhole techniques designed for quicker recovery and reduced discomfort.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Emergency Surgeries –</strong> Immediate surgical care for trauma and acute abdominal conditions.
                    </p>
                </div>
                 ...
                 <div class="w-full lg:w-full space-y-6 flex flex-col mt-10 ">
                    ...
                    <div class="space-y-4">
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Expert Surgeons:</strong> Skilled surgeons with advanced training in laparoscopic and open procedures.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>State-of-the-Art Operating Theatres:</strong> Modern surgical suites equipped with advanced technology.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Comprehensive Care:</strong> From routine surgeries to complex surgical interventions under one roof.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Patient-Centric Approach:</strong> Focused on safety, comfort, and informed decision-making.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Holistic Recovery:</strong> Integrated physiotherapy, rehabilitation, and post-operative care support.
                        </p>
                    </div>
