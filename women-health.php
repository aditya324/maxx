...
<body>
    ...
    <section class="w-full bg-[#FFCDA6] py-10">
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-1/4 flex flex-col gap-3">
                ...
                <a href="./women-health.php" class="w-full flex items-center justify-between bg-brand text-white font-medium py-3 px-4 rounded-md">
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold text-[#6C3130] leading-tight">
                    Overview
                    <span class="text-[#ec8b2a]">Women’s Health Care (OBG & OBGYN)</span>
                </h1>

                <p class="text-gray-700 leading-relaxed text-base font-semibold">
                    Women’s health requires specialized care at every stage of life—from adolescence and reproductive years to pregnancy, childbirth, and menopause. Each phase brings unique physical and emotional needs that require expert attention.
                    <br><br>
                    At MaAx Super Speciality Hospital, our Women’s Health Care Department (Obstetrics & Gynecology) offers comprehensive and compassionate care for reproductive health, maternity services, and gynecological conditions. Our team of obstetricians, gynecologists, fertility specialists, and surgeons provides confidential, personalized, and advanced medical care. From routine checkups and safe deliveries to fertility treatments and complex surgeries, we support women with expertise, empathy, and respect.
                </p>
                ...
                <div class="space-y-2">
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Prenatal & Antenatal Care –</strong> Comprehensive monitoring of maternal health and fetal development.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Labor & Delivery Services –</strong> Safe and supported childbirth with advanced medical facilities.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Fertility Treatments –</strong> IVF, IUI, and individualized hormonal therapies.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Gynecological Surgeries –</strong> Hysterectomy, laparoscopy, fibroid removal, and minimally invasive procedures.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Menstrual Disorder Management –</strong> Treatment for PCOS, endometriosis, and irregular cycles.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Menopause Care –</strong> Hormone therapy, symptom management, and lifestyle counseling.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Cancer Screening –</strong> Early detection of cervical, ovarian, and breast cancers.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Family Planning & Contraception –</strong> Counseling and contraceptive procedures tailored to individual needs.
                    </p>
                </div>
                ...
                <div class="w-full lg:w-2/3 space-y-6 flex flex-col ">
                    ...
                    <div class="space-y-4">
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Expert Specialists:</strong> Experienced obstetricians and gynecologists with advanced training.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Advanced Maternity Units:</strong> Well-equipped labor rooms and neonatal care support.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Comprehensive Fertility Programs:</strong> Personalized fertility treatments designed for individual needs.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Patient-Centric Approach:</strong> Emphasis on privacy, dignity, comfort, and compassionate care.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Holistic Healing:</strong> Integrated counseling, diet planning, and lifestyle guidance.
                        </p>
                    </div>
    ...
    <section class="flex justify-center gap-8 flex-wrap">
        ...
        <div class="w-[400px] rounded-[20px] border border-[#e4d5c6] bg-white shadow-md p-6 text-center">
            ...
            <div class="flex justify-center -mt-2">
                <div class="w-36 h-36 rounded-full bg-[#e9ecef] overflow-hidden">
                    <img src="./assets/doctors/dr-lata.webp" alt="Dr. Lata R Telang" class="w-full h-full object-cover" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 rounded-xl overflow-hidden border border-orange-500 mt-6">
                <a href="./dr-lata.php" class="bg-[#582F28] text-white py-3 text-sm font-medium">
                    View Profile
                </a>
                <a href="./dr-lata.php" class="bg-white text-orange-600 py-3 text-sm font-semibold">
                    Book Appointment
                </a>
            </div>
        ...
        <div class="w-[400px] rounded-[20px] border border-[#e4d5c6] bg-white shadow-md p-6 text-center">
            ...
            <div class="flex justify-center -mt-2">
                <div class="w-36 h-36 rounded-full bg-[#e9ecef] overflow-hidden">
                    <img src="./assets/doctors/Dr Vangara Sushmitha.webp" alt="Dr. Vangara Susmitha" class="w-full h-full object-cover" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 rounded-xl overflow-hidden border border-orange-500 mt-6">
                <a href="./dr-vangera.php" class="bg-[#582F28] text-white py-3 text-sm font-medium">
                    View Profile
                </a>
                <a href="./dr-vangera.php" class="bg-white text-orange-600 py-3 text-sm font-semibold">
                    Book Appointment
                </a>
            </div>
