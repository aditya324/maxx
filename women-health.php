            ...
            lg:text-left lg:items-start lg:justify-center lg:container lg:mx-auto lg:px-6">
                <div class="max-w-lg">
                    ...
                    <p class="text-sm md:text-base lg:text-xl text-gray-200 leading-relaxed mt-2 lg:mt-4">
                        Our Gynecology and Obstetrics team provides comprehensive care for women
                        at every stage of life, offering advanced diagnostics, fertility support,
                        pregnancy care, and treatment for a wide range of women’s health conditions.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div
         ...
         px-5 py-4 lg:px-8 lg:py-5">
            <h3 class="text-lg lg:text-xl font-semibold text-gray-900 mb-2">
                Department of <span class="text-[#f97316]">Women’s Health</span>
            </h3>

            <p class="text-[13px] lg:text-[14px] leading-relaxed text-gray-700">
                The Department of Women’s Health at maAx Hospitals offers complete gynecological
                and maternity care for women of all ages. From routine checkups and fertility
                evaluations to pregnancy care and advanced gynecological treatments, our
                specialists prioritize safe, personalized, and compassionate care across every
            ...
            <div class="grid md:grid-cols-[1.4fr_1fr]">
                ...
                <div class="order-2 md:order-1 px-6 py-8 md:px-10 md:py-10">
                 ...
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Comprehensive Pregnancy & Antenatal Care</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Painless Normal Delivery & C-Section Services</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Fertility Evaluation & Treatment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>PCOS, Thyroid & Hormonal Disorder Management</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Menstrual & Reproductive Health Care</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Uterus, Ovary & Cervical Disorder Treatment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Breast Screening & Women’s Cancer Evaluation</span>
                        </li>
                 ...
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                        ...
                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Adolescent & Menopause Health Support</span>
                        </li>
                    </ul>
                </div>
