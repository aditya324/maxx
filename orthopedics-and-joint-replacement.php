        ...
        <div
         ...
         p-4 md:p-8 lg:p-10 bg-white text-[#4b5563] leading-12">
                <p>
                    ...
                    focuses on the diagnosis and treatment of conditions affecting the bones, joints,
                    ligaments, and muscles. It includes advanced surgical and non-surgical management
