    ...
    <div class="swiper doctorSwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <article
            class="w-full max-w-[280px] mx-auto rounded-2xl bg-white shadow-[0_10px_30px_rgba(15,23,42,0.08)] px-6 pt-8 pb-6 flex flex-col items-center"
          >
            <div
...
<script>
  const doctorSwiper = new Swiper(".doctorSwiper", {
    ...
    breakpoints: {
      0: { slidesPerView: 1.2 },
      640: { slidesPerView: 2 },
      1024: { slidesPerView: 3 }, // 4 cards on desktop
    },
