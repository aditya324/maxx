        ...
        <div
         ...
         p-4 md:p-8 lg:p-10 bg-white text-[#4b5563] leading-12">
                <p>
                    ...
                    is a minimally invasive diagnostic procedure that allows direct visualization
                    of the digestive tract using a flexible tube equipped with a camera and
                    light. It helps detect conditions such as ulcers, inflammation, bleeding,
                    tumors, and digestive disorders while also enabling tissue biopsy and certain
                    therapeutic interventions. MaAx Hospital offers advanced upper GI endoscopy
                    and colonoscopy services with high-resolution imaging, ensuring accurate
                    diagnosis, enhanced patient safety, and minimal discomfort throughout the
                    procedure.
                </p>
            </div>
