...
<head>
    ...
    <title>Dialysis Services | maAx Super Specialty Hospital</title>
                        ...
                        <div
                            ...
                            <div class="max-w-full">
                                ...
                                <p class="text-sm md:text-base lg:text-2xl p-1 bg-white w-2xl rounded-md  leading-relaxed mt-2 lg:mt-4 text-[#6C3130]">
                                    <span class="text-[#F58220]">Advanced Renal Support</span>. Compassionate Care. Life-Sustaining Treatment.
                                </p>
                            </div>
                        </div>
    ...
    <section class="w-full bg-[#FFCDA6] py-10">
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-1/4 flex flex-col gap-3">
                ...
                <a href="./dialysis.php" class="w-full flex items-center justify-between bg-[#ec8b2a] text-white font-medium py-3 px-4 rounded-md">
                    <span>Dialysis</span>
                    <span class="text-xl">&gt;</span>
                </a>
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold text-[#6C3130] leading-tight">
                    Advanced Dialysis Care at
                    <span class="text-[#ec8b2a]">maAx Super Specialty Hospital, Shivamoga</span>
                </h1>

                <p class="text-gray-700 leading-relaxed text-lg">
                    Dialysis is a life-sustaining treatment that performs the essential functions of the kidneys when they are no longer able to work effectively. At maAx Super Speciality Hospital, our Dialysis Unit provides high-quality hemodialysis services for patients with acute and chronic kidney failure.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    Equipped with state-of-the-art dialysis machines and stringent water purification systems, we ensure safe and efficient removal of toxins and excess fluids from the blood. Our expert nephrology team is dedicated to improving the quality of life for our renal patients through clinical excellence.
                </p>
            ...
            <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-20 items-start justify-center">
                ...
                <div class="w-full lg:w-2/3 space-y-6 flex flex-col ">
                    ...
                    <h2 class="text-3xl md:text-3xl font-semibold text-[#6C3130] leading-tight">
                        When is Dialysis Recommended? </h2>
                    <p class="text-gray-700 leading-relaxed text-base">
                        Dialysis is necessary when your kidneys are only performing about 10% to 15% of their normal function. Common conditions that require dialysis intervention include:
                    </p>
                    <ul class="list-disc ml-5 space-y-2">
                        <li class="text-gray-700 leading-relaxed text-base">End-Stage Renal Disease (ESRD)</li>
                        <li class="text-gray-700 leading-relaxed text-base">Acute Kidney Injury (AKI) due to illness or trauma</li>
                        <li class="text-gray-700 leading-relaxed text-base">Chronic Kidney Disease (CKD) stages 4 and 5</li>
                        <li class="text-gray-700 leading-relaxed text-base">Severe fluid overload not responding to medication</li>
                        <li class="text-gray-700 leading-relaxed text-base">Dangerous levels of electrolytes, such as high potassium</li>
                        <li class="text-gray-700 leading-relaxed text-base">Accumulation of toxic waste (Uremia) in the blood</li>
                        <li class="text-gray-700 leading-relaxed text-base">Pre-surgical preparation for kidney transplant patients</li>
                    </ul>
                    <p class="text-gray-700 leading-relaxed text-base">Regular dialysis sessions help maintain the body's chemical balance and control blood pressure when the kidneys fail.</p>
                </div>
        ...
        <div class="flex-1 w-full space-y-10">
            <div>
                ...
                <p class="text-gray-700 leading-relaxed text-base mt-2">
                    Our hemodialysis sessions are performed in a specialized renal unit by trained dialysis technicians under the supervision of expert nephrologists.
                </p>
                <p class="text-gray-700 leading-relaxed text-base mt-2">
                    During the procedure, your blood is pumped through a dialysis machine containing a filter called a dialyzer (artificial kidney). The machine cleans the blood and returns it to your body through a vascular access point, typically an AV fistula, graft, or catheter.
                </p>
                <p class="text-gray-700 leading-relaxed text-base mt-2">
                    The entire process usually takes 3 to 4 hours, and it is performed while you are comfortably seated or lying down in our specialized dialysis chairs.
                </p>
            </div>
            <div>
                <h3 class="text-2xl md:text-3xl font-semibold text-[#6C3130] leading-tight">
                    Safety, Comfort, and Patient Well-being </h3>
                <p class="text-gray-700 leading-relaxed text-base mt-2">
                    At maAx Hospital, patient safety is our highest priority. We use ultra-pure water systems (RO) and strictly follow international sterilization protocols to prevent infections.
                </p>
                <p class="text-gray-700 leading-relaxed text-base mt-2">
                    Our unit is designed for maximum comfort, with reclining chairs and constant monitoring of vital signs. We also provide nutritional guidance to help patients manage their diet between sessions.
                </p>
                <p class="text-gray-700 leading-relaxed text-base mt-2">
                    We offer flexible scheduling for regular maintenance dialysis and provide emergency dialysis support for critically ill patients in the ICU.
                </p>
            </div>
            <div>
                <h3 class="text-2xl md:text-3xl font-semibold text-[#6C3130] leading-tight">
                    Why Choose maAx Super Speciality Hospital for Dialysis in Shivamogga? </h3>

                <ul class="list-disc ml-5 mt-4 space-y-2">
                    <li class="text-gray-700 leading-relaxed text-base">Expert Nephrologists and skilled renal care team</li>
                    <li class="text-gray-700 leading-relaxed text-base">Advanced Hemodialysis and ICU dialysis support</li>
                    <li class="text-gray-700 leading-relaxed text-base">Advanced Water Treatment (RO) systems for safety</li>
                    <li class="text-gray-700 leading-relaxed text-base">Strict adherence to infection control protocols</li>
                    <li class="text-gray-700 leading-relaxed text-base">Affordable and coordinated long-term renal care</li>
                </ul>
                <p class="text-gray-700 leading-relaxed text-base mt-4">maAx Super Speciality Hospital is a trusted centre for Dialysis services in Shivamogga, providing reliable renal support with a focus on patient dignity and health.</p>
            ...
            <section class="w-full  py-12">
                <div class="container mx-auto px-4">
                    <h3 class="text-2xl md:text-3xl font-semibold text-[#6C3130] leading-tight">
                        Advised for dialysis or seeking expert renal consultation?
                    </h3>
            ...
            <div class="rounded-2xl border border-gray-300 divide-y">
                ...
                <details class="group">
                    ...
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70 rounded-t-2xl">
                        <span>1. What is Hemodialysis and how does it work?</span>
                    ...
                    <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                        Hemodialysis is a treatment where a machine filters waste and excess fluid from your blood, acting as an artificial kidney when your natural kidneys fail.
                    </div>
                </details>
                ...
                <details class="group">
                    ...
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                        <span>2. How often do I need dialysis?</span>
                        <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                    </summary>
                    <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                        Most patients require dialysis three times a week. Each session typically lasts between 3 to 4 hours, depending on your health needs.
                    </div>
                </details>
                ...
                <details class="group">
                    ...
                    <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                        The treatment itself is not painful. You may feel a slight pinch when the needles are inserted, but most patients rest, read, or watch TV comfortably during the session.
                    </div>
                </details>
                ...
                <details class="group">
                    ...
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70 rounded-b-2xl">
                        <span>4. Do I need to follow a special diet?</span>
                        <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                    </summary>
                    <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                        Yes. Patients on dialysis usually need to limit fluid intake and monitor their consumption of potassium, phosphorus, and salt. Our team provides detailed nutritional guidance.
                    </div>
                </details>
