            ...
            lg:text-left lg:items-start lg:justify-center lg:container lg:mx-auto lg:px-6">
                <div class="max-w-lg">
                    ...
                    <p class="text-sm md:text-base lg:text-xl text-gray-200 leading-relaxed mt-2 lg:mt-4">
                        Our Nephrology team provides comprehensive evaluation and treatment for acute and
                        chronic kidney disorders. From early diagnosis and dialysis support to long-term
                        renal care, we ensure specialized and compassionate management for patients with
        ...
        <div
         ...
         px-5 py-4 lg:px-8 lg:py-5">
            <h3 class="text-lg lg:text-xl font-semibold text-gray-900 mb-2">
                Department of <span class="text-[#f97316]">Kidney Care</span>
            </h3>

            <p class="text-[13px] lg:text-[14px] leading-relaxed text-gray-700">
                The Department of Kidney Care at maAx Hospitals offers expert nephrology services
                focused on the diagnosis, treatment, and long-term management of kidney disorders.
                Using advanced diagnostic tools and modern dialysis facilities, our team ensures
                personalized and effective care for patients with complex renal conditions.
            </p>
        </div>
            ...
            <div class="grid md:grid-cols-[1.4fr_1fr]">
                ...
                <div class="order-2 md:order-1 px-6 py-8 md:px-10 md:py-10">
                 ...
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Evaluation & Management of Kidney Diseases</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Acute & Chronic Kidney Failure Treatment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Dialysis Services (Hemodialysis & Peritoneal Dialysis)</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Kidney Stone Diagnosis & Treatment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Management of Hypertension Related to Kidney Disease</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Urinary Tract Infection (UTI) Treatment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Electrolyte Imbalance Management</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Diabetic & Hypertensive Kidney Disease Care</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Renal Health Monitoring & Preventive Care</span>
                        </li>
