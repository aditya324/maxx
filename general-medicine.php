        ...
        <div
         ...
         p-4 md:p-8 lg:p-10 bg-white text-[#4b5563] leading-12">
                <p>
                    ...
                    focuses on the prevention, diagnosis, and management of a wide range of adult
                    health conditions. It plays a key role in treating chronic illnesses such as
                    diabetes, hypertension, infections, digestive disorders, respiratory diseases,
                    and lifestyle-related health issues. At MaAx Hospital, our general physicians
                    provide comprehensive, evidence-based care with personalized treatment plans
                    aimed at promoting long-term health, early detection of risks, and effective
                    disease management for patients of all backgrounds.
                </p>
            </div>
