                        ...
                        <div
                            ...
                            <div class="max-w-full">
                                ...
                                <p class="text-sm md:text-base lg:text-2xl p-1 bg-white w-2xl rounded-md leading-relaxed mt-2 lg:mt-4 text-[#6C3130]">
                                    <span class="text-[#F58220]">Advanced Renal Care</span>. Safe Dialysis. Trusted Expertise.
                                </p>
                            </div>
                        </div>
    ...
    <section class="w-full bg-white py-10">
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <p class="text-gray-700 leading-relaxed text-lg">
                    MaAx Super Specialty Hospital offers advanced dialysis care for patients with chronic kidney disease and acute kidney failure. Our dialysis unit provides round-the-clock support using modern hemodialysis systems designed to remove waste, excess fluids, and toxins safely from the blood when the kidneys are unable to function effectively.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    Every dialysis session is supervised by experienced nephrologists and skilled dialysis technicians in a sterile and closely monitored clinical environment. With comfortable patient stations, purified water systems, and continuous monitoring, MaAx ensures a safe and stress-free treatment experience.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    We provide personalised treatment plans for each patient, including routine hemodialysis, emergency dialysis, and dialysis support for inpatients and ICU cases. Nutrition guidance, infection control, emotional support, and ongoing medical counselling are integrated into every care plan.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    MaAx Super Specialty Hospital offers reliable, affordable dialysis services in Shivamogga with flexible scheduling and coordinated care to improve quality of life and long-term health outcomes.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    If you or a loved one is living with kidney disease, MaAx Super Specialty Hospital provides trusted dialysis care in Shivamogga through compassionate support and advanced renal treatment expertise.
                </p>
        ...
        <section class="w-full  py-14">
            ...
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70 rounded-t-2xl">
                                <span>1. What is dialysis and why is it needed?</span>
                            ...
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70 rounded-b-2xl">
                                Dialysis is a treatment that replaces kidney function by removing toxins, fluids, and waste products from the blood when the kidneys can no longer do so naturally. It supports patients with chronic kidney disease or kidney failure.
                            </div>
                        </details>
            ...
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>2. Is dialysis a safe procedure?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                Yes. Dialysis is safe when performed by trained nephrologists and dialysis technicians. Patients are closely monitored during treatment to ensure comfort and stable health.
                            </div>
                        </details>
                        ...
                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>3. How much does dialysis cost in Shivamogga?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                Dialysis cost varies based on treatment frequency, medical condition, and duration of care. All pricing information is shared transparently before treatment.
                            </div>
                        </details>
                        ...
                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>4. Why choose MaAx Super Specialty Hospital for dialysis?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                MaAx provides advanced dialysis machines, sterile clinical conditions, expert nephrologists, 24/7 renal care support, and personalised long-term treatment planning.
                            </div>
                        </details>
                        ...
                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>5. How long does a dialysis session take?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                A typical dialysis session lasts about 3–4 hours and may be required two to three times per week depending on kidney condition and doctor advice.
                            </div>
                        </details>
