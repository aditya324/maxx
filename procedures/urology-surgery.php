            ...
            <div class="swiper-slide">
                <div class="flex flex-col lg:block relative lg:min-h-[600px]">
                    <div
                        ...
                        style="background-image: url('../assets/procedures/urology-care.webp');">
            ...
            <div class="w-full lg:w-1/4 space-y-6">
                ...
                <div class=" rounded-xl  p-5">
                    ...
                    <div class="space-y-2 text-sm font-medium">
                        ...
                        <a href="./urology-surgery.php" class="flex justify-between items-center bg-brand text-white px-4 py-2 rounded">Urology Surgery <span>›</span></a>
            ...
            <div class="w-full lg:w-3/4 space-y-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-[#6C3130]">
                            Urology Surgery at <span class="text-[#ec8b2a]">maAx Super Speciality Hospital</span>
                        </h1>
                    </div>
                    <img src="../assets/procedures/urology-care.webp" alt="Urology Surgery" class="w-full md:w-96 rounded-lg shadow">
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Urology surgery involves the diagnosis and surgical treatment of conditions affecting the urinary
                        tract and male reproductive system. This includes organs such as the kidneys, ureters, bladder,
                        urethra, and prostate.
                    </p>
                    <p class="text-gray-700 leading-relaxed mt-3">
                        At maAx Super Speciality Hospital, urological surgeries are performed for conditions like kidney stones,
                        prostate enlargement, urinary tract obstructions, cancers, and male reproductive disorders.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        <li>Minimally invasive procedures such as endoscopy and laparoscopy.</li>
                        <li>Laser treatments for kidney stones and prostate conditions.</li>
                        <li>Open or robotic surgeries in complex cases.</li>
                    </ul>
                    <p class="text-gray-700 leading-relaxed mt-3">
                        The type of surgery depends on the condition, and most modern procedures allow faster recovery
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                <li>Effective treatment for urinary and kidney conditions</li>
                                <li>Minimally invasive techniques with quicker recovery</li>
                                <li>Improved quality of life and symptom relief</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                ...
                                <li>Temporary urinary discomfort</li>
                                <li>Risk depending on complexity of surgery</li>
                            </ul>
                        </div>
                    ...
                    <p class="text-gray-700 leading-relaxed mt-4">
                        At maAx Super Speciality Hospital, advanced technology and experienced urologists ensure safe,
                        precise, and effective surgical outcomes.
                    </p>
                </div>
                ...
                <div>
                    <h2 class="text-xl font-bold text-[#6C3130] mb-4">
                        FAQs on Urology Surgery at <span class="text-[#ec8b2a]">maAx Super Speciality Hospital</span>
                    </h2>
                    ...
                    <div class="border rounded-xl divide-y">
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">No, many procedures are minimally invasive and done as day-care surgeries.</p>
                        </details>
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">Yes, laser lithotripsy is commonly used to break and remove kidney stones.</p>
                        </details>
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">Recovery varies depending on the procedure, but minimally invasive surgeries allow faster return to normal activities.</p>
                        </details>
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">If you have symptoms like pain during urination, kidney stones, urinary infections, or prostate issues, you should consult a specialist.</p>
                        </details>
