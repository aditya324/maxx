...
<head>
    ...
    <title>Valve Replacement Surgery</title>
            ...
            <div class="swiper-slide">
                <div class="flex flex-col lg:block relative lg:min-h-[600px]">
                    <div
                        ...
                        style="background-image: url('../assets/procedures/valve-replacement.webp');">
            ...
            <div class="w-full lg:w-1/4 space-y-6">
                ...
                <div class=" rounded-xl  p-5">
                    ...
                    <div class="space-y-2 text-sm font-medium">
                        ...
                        <a href="./valve-replacement.php" class="flex justify-between items-center bg-brand text-white px-4 py-2 rounded">Valve Replacement <span>›</span></a>
            ...
            <div class="w-full lg:w-3/4 space-y-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-[#6C3130]">
                            Valve Replacement Surgery at <span class="text-[#ec8b2a]">maAx Super Speciality Hospital</span>
                        </h1>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Valve replacement surgery is a cardiac procedure used to replace a damaged or diseased heart valve.
                        Heart valves regulate blood flow through the heart, and when they do not function properly,
                        it can lead to serious complications such as heart failure.
                    </p>
                    <p class="text-gray-700 leading-relaxed mt-3">
                        At maAx Super Speciality Hospital, this surgery is recommended for conditions like valve stenosis
                        (narrowing) or valve regurgitation (leakage), ensuring proper blood circulation and improved heart function.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        <li>Open-heart surgery where the damaged valve is replaced with a mechanical or biological valve.</li>
                        <li>Minimally invasive or catheter-based procedures (like TAVR) in selected patients.</li>
                        <li>The surgery is performed under general anesthesia with advanced monitoring.</li>
                    </ul>
                    <p class="text-gray-700 leading-relaxed mt-3">
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                <li>Improved heart function and blood flow</li>
                                <li>Relief from symptoms like breathlessness and fatigue</li>
                                <li>Enhanced quality of life and longevity</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                ...
                                <li>Blood clots or stroke (rare)</li>
                                <li>Need for long-term medication in some cases</li>
                            </ul>
                        </div>
                    ...
                    <p class="text-gray-700 leading-relaxed mt-4">
                        At maAx Super Speciality Hospital, advanced cardiac care and experienced surgeons ensure safe
                        and successful valve replacement procedures.
                    </p>
                </div>
                ...
                <div>
                    <h2 class="text-xl font-bold text-[#6C3130] mb-4">
                        FAQs on Valve Replacement Surgery at <span class="text-[#ec8b2a]">maAx Super Speciality Hospital</span>
                    </h2>
                    ...
                    <div class="border rounded-xl divide-y">
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">The surgery typically takes 3–5 hours depending on complexity.</p>
                        </details>
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">Most patients recover within 6–8 weeks, with gradual return to normal activities.</p>
                        </details>
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">Mechanical valves last longer but require lifelong medication, while biological valves may wear out over time but often need less medication.</p>
                        </details>
                        ...
                        <details class="p-4 group">
                            ...
                            <p class="mt-2 text-sm text-gray-600">Yes, with modern techniques and experienced surgeons, it is a safe and effective procedure.</p>
                        </details>
