                        ...
                        <div
                            ...
                            <div class="max-w-full">
                                ...
                                <p class="text-sm md:text-base lg:text-2xl p-1 bg-white w-2xl rounded-md  leading-relaxed mt-2 lg:mt-4 text-[#6C3130]">
                                    <span class="text-[#F58220]">Cardiac Stress Testing Through</span> Treadmill Test (TMT)
                                </p>
                            </div>
                        </div>
        ...
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold text-[#6C3130] leading-tight">
                    Treadmill Test (TMT) at
                    <span class="text-[#ec8b2a]">maAx Super Specialty Hospital, Shivamoga</span>
                </h1>

                <p class="text-gray-700 leading-relaxed text-base">
                    The Treadmill Test (TMT), also known as a cardiac stress test, is used to evaluate how the heart responds to physical exertion. At maAx Super Speciality Hospital, TMT is performed to assess heart function, blood flow, and rhythm during exercise.
                </p>
        ...
        <section class="w-full  py-14">
            <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-20 items-start justify-center">
                ...
                <div class="w-full lg:w-2/3 space-y-6 flex flex-col ">
                    ...
                    <p class="text-gray-700 leading-relaxed text-base">
                        A TMT may be advised when symptoms or risk factors suggest possible heart disease or to assess exercise tolerance. Common indications include:
                    <ul class="list-disc">
                        <li class="text-gray-700 leading-relaxed text-base">
                            Chest pain or discomfort during activity </li>

                        <li class="text-gray-700 leading-relaxed text-base">

                            Shortness of breath on exertion </li>

                        <li class="text-gray-700 leading-relaxed text-base">
                            Unexplained fatigue </li>

                        <li class="text-gray-700 leading-relaxed text-base">
                            Abnormal ECG findings </li>
                        <li class="text-gray-700 leading-relaxed text-base">
                            Suspected or known coronary artery disease </li>
                        <li class="text-gray-700 leading-relaxed text-base">
                            Assessment after heart procedures </li>
                        <li class="text-gray-700 leading-relaxed text-base">
                            Evaluation of fitness for physical activity or surgery </li>
                        <li class="text-gray-700 leading-relaxed text-base">
                            Monitoring response to cardiac treatment </li>


                    </ul>
                    <h3 class="text-2xl md:text-3xl font-semibold text-[#6C3130] leading-tight">
                        What Conditions Can Be Evaluated Through TMT? </h3>
                    <p class="text-gray-700 leading-relaxed text-base">
                        TMT helps in the evaluation of several cardiac conditions, including:
                    <ul class="list-disc">
                        <li class="text-gray-700 leading-relaxed text-base">
                        ...
                        <li class="text-gray-700 leading-relaxed text-base">
                            Abnormal heart rhythms during exertion </li>

                        <li class="text-gray-700 leading-relaxed text-base">
                            Reduced exercise tolerance </li>
                        <li class="text-gray-700 leading-relaxed text-base">
                            Cardiac functional capacity</li>
                        <li class="text-gray-700 leading-relaxed text-base">
                            Effectiveness of cardiac treatment </li>
    ...
    <section class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-12 items-start justify-center">
        <div class="flex-1 w-full space-y-10">
            <div>
                ...
                <p class="text-gray-700 leading-relaxed text-base">
                    TMT at maAx Super Speciality Hospital is conducted under medical supervision in a controlled environment.
                <p class="text-gray-700 leading-relaxed text-base">Electrodes are placed on the chest to monitor heart activity, and blood pressure is measured throughout the test. The patient walks on a treadmill with gradually increasing speed and incline.</p>
                <p class="text-gray-700 leading-relaxed text-base">The test continues until the target heart rate is achieved, symptoms develop, or the doctor decides to stop the test. The entire process usually takes 15 to 30 minutes, including recovery time.</p>


            </div>
            <div>
                <h3 class="text-2xl md:text-3xl font-semibold text-[#6C3130] leading-tight">
                    Safety, Monitoring, and Patient Care </h3>
                <p class="text-gray-700 leading-relaxed text-base">
                    TMT is a well-established and safe test when performed under medical supervision. Patients are closely monitored throughout the procedure
                ...
                <p class="text-gray-700 leading-relaxed text-base">The test can be stopped immediately if symptoms such as chest pain, dizziness, or excessive fatigue occur. Emergency support is readily available if required.</p>

            </div>
            <div>
                <h3 class="text-2xl md:text-3xl font-semibold text-[#6C3130] leading-tight">
                   Why Choose maAx Super Speciality Hospital for TMT in Shivamogga? </h3>
                  <ul class="list-disc">
                    <li class="text-gray-700 leading-relaxed text-base">
                    ...
                    <li class="text-gray-700 leading-relaxed text-base">
                        ...
                        Continuous ECG and blood pressure monitoring </li>
                    ...
                    <li class="text-gray-700 leading-relaxed text-base">
                        ...
                        Integrated cardiac diagnostic services </li>

                    <p class="text-gray-700 leading-relaxed text-base">maAx Super Speciality Hospital offers reliable TMT services in Shivamogga, supporting early detection and evaluation of heart conditions.</p>
            ...
            <div>
                ...
                <section class="w-full  py-12">
                    ...
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70 rounded-t-2xl">
                                <span>1. What is a TMT used for?</span>
                            ...
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70 rounded-b-2xl">
                                TMT evaluates how the heart responds to physical exertion and helps detect heart-related problems that may not appear at rest. </div>
                        </details>

                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>2. Is the TMT painful?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                 No. TMT involves walking on a treadmill, though some patients may feel tired or short of breath during exercise. </div>
                        </details>

                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>3. How long does a TMT take?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                 The test usually takes 15 to 30 minutes, including preparation and recovery. </div>
                        </details>
                    ...
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                        ...
                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
                    text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>5. Who should not undergo TMT? </span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                 Patients with certain heart conditions may not be suitable. Eligibility is assessed by the doctor before the test.
                            </div>
                        </details>
