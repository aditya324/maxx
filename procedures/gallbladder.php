...
<head>
  ...
  <title>Gallbladder Removal (Cholecystectomy)</title>
      ...
      <div class="w-full lg:w-3/4 space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <h1 class="text-3xl md:text-4xl font-bold text-[#6C3130]">
              Gallbladder Removal (Cholecystectomy) at <span class="text-[#ec8b2a]">MaAx Super Speciality Hospital</span>
            </h1>
          </div>
          <img src="../assets/procedures/gallbladder-removal.webp" alt="Gallbladder Removal Surgery" class="w-full md:w-96 rounded-lg shadow">
        </div>
        ...
        <div>
          ...
          <p class="text-gray-700 leading-relaxed">
            Gallbladder removal, or cholecystectomy, is performed to treat gallstones, gallbladder infections,
            or bile duct blockages. At MaAx Super Speciality Hospital, this procedure is recommended when
            gallstones cause severe pain, indigestion, or complications such as pancreatitis.
          </p>
          <p class="text-gray-700 leading-relaxed mt-3">
            Removing the gallbladder prevents recurrence of gallstones and helps restore digestive health.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="list-disc list-inside text-gray-700 space-y-2">
            <li><strong>Laparoscopic Cholecystectomy:</strong> Minimally invasive surgery using small incisions and a camera.</li>
            <li><strong>Open Cholecystectomy:</strong> A larger incision is made in the abdomen (used in complex cases).</li>
            <li>The gallbladder is carefully detached and removed.</li>
            <li>The procedure usually takes 1–2 hours, and patients can often return home within 1–2 days.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-green-50 border border-green-200 rounded-xl p-4">
              ...
              <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                <li>Relief from gallstone pain and digestive discomfort</li>
                <li>Prevents recurrence of gallstones</li>
                <li>Minimally invasive option offers faster recovery and minimal scarring</li>
              </ul>
            </div>
            ...
            <div class="bg-red-50 border border-red-200 rounded-xl p-4">
              ...
              <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                ...
                <li>Rare injury to nearby organs such as bile ducts or intestines</li>
                <li>Temporary digestive changes after surgery</li>
              </ul>
            </div>
          ...
          <p class="text-gray-700 leading-relaxed mt-4">
            At MaAx Super Speciality Hospital, laparoscopic techniques and expert surgeons ensure safe,
            effective gallbladder removal with quick recovery.
          </p>
        </div>
