                        ...
                        <div
                            ...
                            <div class="max-w-full">
                                ...
                                <p class="text-sm md:text-base lg:text-2xl p-1 bg-white w-2xl rounded-md leading-relaxed mt-2 lg:mt-4 text-[#6C3130]">
                                    <span class="text-[#F58220]">Radiation-Free Imaging</span>. High Detail. Accurate Results.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="w-full bg-white py-10">
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold text-[#6C3130] leading-tight">
                    MRI Scan Diagnosis at
                    <span class="text-[#ec8b2a]">maAx Super Specialty Hospital, Shivamoga</span>
                </h1>

                <p class="text-gray-700 leading-relaxed text-lg">
                    MaAx Super Specialty Hospital offers advanced MRI scanning for accurate and detailed visualization of internal organs, tissues, joints, and the nervous system. MRI (Magnetic Resonance Imaging) uses strong magnetic fields and radio waves to produce high-definition images without radiation exposure.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    Our MRI unit features modern high-resolution scanners that support brain, spine, musculoskeletal, abdominal, pelvic, vascular, and cardiac imaging. The scan enables early detection of tumors, nerve damage, ligament tears, spinal diseases, stroke, infections, and soft tissue injuries.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    All MRI scans are performed under the supervision of skilled radiologists and trained MRI technologists in a safe, comfortable clinical setting. Noise-reducing technology and patient monitoring ensure a smooth scanning experience for both adults and children.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    MaAx provides contrast and non-contrast MRI scans based on medical requirements, including emergency and trauma imaging. Image interpretation and reporting are completed promptly to support timely clinical decisions.
                </p>

                <p class="text-gray-700 leading-relaxed text-lg">
                    If you require precise and radiation-free imaging, MaAx Super Specialty Hospital is a trusted centre for MRI Scans in Shivamogga, offering diagnostic excellence with compassionate care.
                </p>
        ...
        <section class="w-full  py-14">
            ...
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70 rounded-t-2xl">
                                <span>1. What is an MRI Scan and why is it done?</span>
                            ...
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70 rounded-b-2xl">
                                An MRI Scan is a radiation-free imaging test that uses magnetic fields to capture detailed internal body images. It helps diagnose neurological disorders, spine problems, ligament injuries, tumors, organ diseases, infections, and vascular conditions.
                            </div>
                        </details>
            ...
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>2. Is an MRI Scan safe?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                Yes. MRI is safe and does not use radiation. However, it is not suitable for patients with certain metal implants, pacemakers, or cochlear devices. Screening is performed before the scan to ensure safety.
                            </div>
                        </details>
                        ...
                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>3. How much does an MRI Scan cost in Shivamogga?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                Cost varies depending on the body area scanned, contrast requirement, and clinical complexity. Transparent pricing is shared before the procedure.
                            </div>
                        </details>
                        ...
                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>4. Why choose MaAx Super Specialty Hospital for MRI Scans?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                MaAx offers advanced MRI scanners, expert radiologists, fast reporting, comfortable scan sessions, and accurate image interpretation under one roof.
                            </div>
                        </details>
                        ...
                        <details class="group">
                            <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
            text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                                <span>5. How long does an MRI Scan take?</span>
                                <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                            </summary>
                            <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                                Most MRI scans take 20–45 minutes depending on the body area and whether contrast is used.
                            </div>
                        </details>
