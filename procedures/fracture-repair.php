...
<head>
    ...
    <title>Fracture Repair Treatment</title>
            ...
            <div class="w-full lg:w-3/4 space-y-8">
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        <li><strong>Closed Reduction:</strong> The bone is realigned without surgery, often followed by casting or splinting.</li>
                        <li><strong>Open Reduction & Internal Fixation (ORIF):</strong> Surgery is performed to realign the bone, using plates, screws, or rods.</li>
                        <li><strong>External Fixation:</strong> A stabilizing frame is attached outside the body to hold bones in place.</li>
                        <li><strong>Rehabilitation:</strong> Physiotherapy is provided to restore strength and mobility.</li>
                    </ul>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                <li>Restores normal bone alignment and function</li>
                                <li>Prevents long-term complications such as deformity or arthritis</li>
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                ...
                                <li>Delayed healing or non-union of the bone</li>
                                <li>Rare complications such as nerve or vessel injury</li>
                            </ul>
                        </div>
