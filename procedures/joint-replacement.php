            ...
            <div class="swiper-slide">
                <div class="flex flex-col lg:block relative lg:min-h-[600px]">
                    <div
                        ...
                        style="background-image: url('../assets/procedures/Joint Surgery.webp');">
            ...
            <div class="w-full lg:w-1/4 space-y-6">
                ...
                <div class=" rounded-xl  p-5">
                    ...
                    <div class="space-y-2 text-sm font-medium">
                        ...
                        <a href="./joint-replacement.php" class="flex justify-between items-center bg-brand text-white px-4 py-2 rounded">Joint Replacement <span>›</span></a>
                    </div>
            ...
            <div class="w-full lg:w-3/4 space-y-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-[#6C3130]">
                            Joint Replacement at <span class="text-[#ec8b2a]">maAx Super Speciality Hospital</span>
                        </h1>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Joint replacement surgery is performed to replace a damaged joint with an artificial implant.
                        At maAx Super Speciality Hospital, this procedure is recommended for patients suffering from severe arthritis,
                        joint degeneration, or trauma that causes chronic pain and loss of mobility.
                    </p>
                    <p class="text-gray-700 leading-relaxed mt-3">
                        The goal is to relieve pain, restore function, and improve quality of life.
                        Commonly replaced joints include the hip, knee, and shoulder.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        <li>The damaged joint surfaces are removed surgically.</li>
                        <li>Artificial implants made of metal, ceramic, or plastic are inserted to replicate natural movement.</li>
                        <li>The procedure is performed under general or spinal anesthesia.</li>
                        <li>Recovery involves physiotherapy to regain strength and mobility.</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                ...
                                <li>Long-lasting results with modern implants</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-xl p-4">
                            ...
                            <ul class="list-disc list-inside text-gray-700 text-sm space-y-1">
                                ...
                                <li>Blood clots or implant loosening</li>
                    ...
                    <p class="text-gray-700 leading-relaxed mt-4">
                        At maAx Super Speciality Hospital, advanced surgical techniques and rehabilitation programs
                        ensure safe and effective joint replacement.
                    </p>
                </div>
