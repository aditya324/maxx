        ...
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold text-[#6C3130] leading-tight">
                    Overview
                    <span class="text-[#ec8b2a]">Mental Health Care</span>
                </h1>
                ...
                <div class="space-y-2">
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Depression & Anxiety Management –</strong> Counseling, psychotherapy, and medication support.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Bipolar Disorder Care –</strong> Mood stabilization, therapy, and long-term monitoring.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Stress & Trauma Therapy –</strong> Cognitive behavioral therapy, trauma-focused care, and mindfulness programs.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Child & Adolescent Psychiatry –</strong> Diagnosis and support for ADHD, autism, and behavioral disorders.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Addiction Recovery Programs –</strong> Counseling, detoxification, and structured rehabilitation.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Sleep Disorder Management –</strong> Treatment for insomnia and sleep-related conditions.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Family & Relationship Counseling –</strong> Therapy for couples and families to strengthen relationships.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Psychiatric Emergency Care –</strong> Immediate assessment and crisis intervention support.
                    </p>
                </div>
                ...
                <div class="w-full lg:w-2/3 space-y-6 flex flex-col ">
                    ...
                    <div class="space-y-4">
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Expert Specialists:</strong> Experienced psychiatrists and psychologists with diverse clinical expertise.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Safe & Supportive Environment:</strong> Confidential, stigma-free care focused on patient comfort.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Holistic Programs:</strong> Integrated therapy, medication management, and lifestyle modification.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Patient-Centric Care:</strong> Personalized treatment plans tailored to individual needs.
                        </p>
                        <p class="text-gray-700 leading-relaxed text-base">
                            <strong>Community Outreach:</strong> Awareness, prevention, and mental health education initiatives.
                        </p>
                    </div>
        ...
        <div class="rounded-2xl border border-gray-300 divide-y">
            ...
            <details class="group">
                ...
                text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70 rounded-t-2xl">
                    <span>1. What conditions are treated under Mental Health Care?</span>
                ...
                <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70 rounded-b-2xl">
                    Mental Health Care includes treatment for depression, anxiety, bipolar disorder, stress-related disorders, addiction, sleep disorders, and emotional or behavioral concerns in children and adults.
                </div>
            </details>
            ...
            <details class="group">
                ...
                text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                    <span>2. When should I seek professional mental health support?</span>
                    <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                </summary>
                <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                    You should seek help if you experience persistent sadness, anxiety, mood swings, sleep disturbances, difficulty coping with stress, or changes in behavior affecting daily life.
                </div>
            </details>
            ...
            <details class="group">
                <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
                text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                    <span>3. Is mental health treatment confidential?</span>
                    <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                </summary>
                <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                    Yes. All consultations and treatments are strictly confidential. We provide care in a safe, respectful, and stigma-free environment.
                </div>
            </details>
            ...
            <details class="group">
                <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
                text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                    <span>4. Do all mental health conditions require medication?</span>
                    <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                </summary>
                <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                    Not always. Many conditions improve with counseling and therapy alone, while others may benefit from medication. Treatment plans are personalized for each patient.
                </div>
            </details>
            ...
            <details class="group">
                <summary class="flex justify-between items-center py-4 px-6 cursor-pointer font-medium
                text-gray-700 group-open:text-[#ec8b2a] group-open:bg-orange-50/70">
                    <span>5. Do you provide emergency mental health care?</span>
                    <span class="transition-transform group-open:rotate-180 text-xl group-open:text-[#ec8b2a]">▲</span>
                </summary>
                <div class="px-6 pb-4 pt-2 text-gray-600 leading-relaxed bg-orange-50/70">
                    Yes. We offer psychiatric emergency care for acute crises, severe emotional distress, and situations requiring immediate professional intervention.
                </div>
            </details>
