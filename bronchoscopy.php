...
<body class="bg-surface-soft font-sans">
 ...
 <div
  ...
  <p>
    ...
    is a diagnostic and therapeutic procedure used to examine the airways and
    lungs using a thin, flexible tube called a bronchoscope. It helps identify
    infections, tumors, blockages, bleeding, and chronic lung diseases while also
    allowing sample collection for laboratory analysis. MaAx Hospital offers
    advanced bronchoscopy services, including flexible and rigid techniques,
    ensuring clear airway visualization, precise diagnosis, and safe intervention
    with minimal discomfort for patients.
  </p>
</div>
