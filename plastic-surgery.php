        ...
        <div
         ...
         p-4 md:p-8 lg:p-10 bg-white text-[#4b5563] leading-12">
                <p>
                    ...
                    focuses on reconstructive and cosmetic procedures aimed at restoring form,
                    function, and appearance. It includes treatment for trauma-related injuries,
                    burns, congenital deformities, skin lesions, and aesthetic enhancements. At
                    MaAx Hospital, our plastic surgery team uses advanced surgical techniques,
                    microsurgery, and minimally invasive methods to deliver safe, precise, and
                    natural-looking results tailored to each patient’s individual needs and goals.
                </p>
            </div>
