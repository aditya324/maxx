            ...
            lg:text-left lg:items-start lg:justify-center lg:container lg:mx-auto lg:px-6">
                <div class="max-w-lg">
                    ...
                    <p class="text-sm md:text-base lg:text-xl text-gray-200 leading-relaxed mt-2 lg:mt-4">
                        Our Critical Care & ICU team provides round-the-clock intensive monitoring and advanced life-support
                        for critically ill patients. Equipped with modern ventilators, hemodynamic monitoring, and a
                        multidisciplinary team, we deliver timely, evidence-based interventions to stabilise and recover
                        patients with severe medical and surgical emergencies.
                    </p>
                </div>
            </div>
        ...
        <div
         ...
         px-5 py-4 lg:px-8 lg:py-5">
            <h3 class="text-lg lg:text-xl font-semibold text-gray-900 mb-2">
                Department of <span class="text-[#f97316]">Critical Care & ICU</span>
            </h3>
            ...
            <p class="text-[13px] lg:text-[14px] leading-relaxed text-gray-700">
                ...
                support, and coordinated transition to step-down care.
            </p>
        </div>
            ...
            <div class="grid md:grid-cols-[1.4fr_1fr]">
                ...
                <div class="order-2 md:order-1 px-6 py-8 md:px-10 md:py-10">
                 ...
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>24/7 Intensive Monitoring & Critical Care Management</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Advanced Ventilator & Respiratory Support</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Hemodynamic Monitoring & Vasopressor Therapy</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Sepsis & Multi-organ Failure Management</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Advanced Cardiac Life Support (ACLS) & Post-Cardiac Arrest Care</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Renal Replacement Therapy (CRRT & Dialysis Support)</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Invasive Monitoring: Central Line, Arterial Line</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Mechanical Ventilation Weaning & Tracheostomy Care</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Neurocritical Care & Post-operative ICU Support</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Pain Management & Multidisciplinary Rehabilitation Planning</span>
                        </li>
