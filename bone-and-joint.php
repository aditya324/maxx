            ...
            lg:text-left lg:items-start lg:justify-center lg:container lg:mx-auto lg:px-6">
                <div class="max-w-lg">
                    ...
                    <p class="text-sm md:text-base lg:text-xl text-gray-200 leading-relaxed mt-2 lg:mt-4">
                        Our Orthopedic Specialists provide advanced treatments for fractures,
                        joint pain, arthritis, spine disorders, and sports injuries with precise diagnosis
                        and state-of-the-art surgical and non-surgical solutions.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div
         ...
         px-5 py-4 lg:px-8 lg:py-5">
            <h3 class="text-lg lg:text-xl font-semibold text-gray-900 mb-2">
                Department of <span class="text-[#f97316]">Bone & Joint Care</span>
            </h3>

            <p class="text-[13px] lg:text-[14px] leading-relaxed text-gray-700">
                The Department of Bone & Joint Care at maAx Hospitals provides advanced orthopedic
                services for fractures, arthritis, sports injuries, and spine disorders. Our team
                of orthopedic surgeons and rehabilitation specialists ensures comprehensive care
                through both surgical and non-surgical treatments to restore mobility and improve
                quality of life.
            </p>
        </div>
            ...
            <div class="grid md:grid-cols-[1.4fr_1fr]">
                ...
                <div class="order-2 md:order-1 px-6 py-8 md:px-10 md:py-10">
                 ...
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Fracture Treatment & Bone Realignment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Knee & Hip Replacement Surgery</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Arthroscopy for Shoulder & Knee Injuries</span>
                        </li>
                 ...
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                        ...
                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Spine Care & Minimally Invasive Spine Surgery</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Arthritis & Joint Pain Treatment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Hand, Wrist & Foot Orthopedic Care</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Osteoporosis Evaluation & Treatment</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Tendon, Ligament & Soft Tissue Repair</span>
                        </li>
