  ...
  <script>
    ...
    wrapper.innerHTML = relatedDoctors.map(doc => `
      <div class="swiper-slide">
        <article class="w-full h-full rounded-2xl bg-white shadow px-6 pt-8 pb-6 flex flex-col items-center">
          ...
          <h3 class="mt-4 text-lg font-semibold text-center">${doc.name}</h3>
          <p class="text-sm text-gray-500 text-center">${doc.degree}</p>
          <p class="text-sm text-orange-500 font-medium mt-1 text-center">${doc.specialty}</p>
