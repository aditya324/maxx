        ...
        <div class="container mx-auto px-5 lg:px-10 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3 space-y-6 ">
                ...
                <h1 class="text-3xl md:text-4xl font-semibold text-[#6C3130] leading-tight">
                    Overview
                    <span class="text-[#ec8b2a]">Child Surgery Care</span>
                </h1>
                ...
                <div class="space-y-2">
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Congenital Anomaly Corrections –</strong> Surgical treatment for birth defects such as cleft lip and palate.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Hernia & Hydrocele Repairs –</strong> Minimally invasive procedures for common pediatric conditions.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Gastrointestinal Surgeries –</strong> Correction of intestinal blockages, malformations, and related disorders.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Urological Surgeries –</strong> Procedures for kidney, bladder, and urinary tract conditions.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Trauma & Emergency Surgeries –</strong> Immediate surgical care for accidents and injuries.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Neonatal Surgeries –</strong> Specialized surgical care for newborns with critical conditions.
                    </p>
                    <p class="text-gray-700 text-base font-semibold">
                        <strong>Minimally Invasive Pediatric Surgery –</strong> Laparoscopic techniques designed for quicker recovery.
                    </p>
                </div>
