            ...
            lg:text-left lg:items-start lg:justify-center lg:container lg:mx-auto lg:px-6">
                <div class="max-w-lg">
                    ...
                    <p class="text-sm md:text-base lg:text-xl text-gray-200 leading-relaxed mt-2 lg:mt-4">
                        Our Rehabilitation & Recovery unit helps patients regain mobility, strength, and
                        independence after injury, surgery, or chronic conditions. With personalized
                        therapy plans, advanced rehabilitation techniques, and holistic recovery support,
                        we ensure a smooth and effective return to daily life.
                    </p>
                </div>
            </div>
        ...
        <div
         ...
         px-5 py-4 lg:px-8 lg:py-5">
            <h3 class="text-lg lg:text-xl font-semibold text-gray-900 mb-2">
                Department of <span class="text-[#f97316]">Rehabilitation & Recovery</span>
            </h3>

            <p class="text-[13px] lg:text-[14px] leading-relaxed text-gray-700">
                The Department of Rehabilitation & Recovery at maAx Hospitals focuses on restoring
                physical function, mobility, and quality of life after illnesses, injuries, and
                surgeries. With expert physiotherapists, rehabilitation specialists, and a
                patient-centric approach, our unit delivers structured recovery plans tailored
                to each patient’s medical needs and lifestyle goals.
            </p>
        </div>
            ...
            <div class="grid md:grid-cols-[1.4fr_1fr]">
                ...
                <div class="order-2 md:order-1 px-6 py-8 md:px-10 md:py-10">
                 ...
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Physiotherapy for Pain Relief & Mobility Improvement</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Post-Surgical Rehabilitation & Strength Training</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Neurological Rehabilitation for Stroke & Brain Injuries</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Orthopedic Rehabilitation for Joint & Spine Conditions</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Sports Injury Recovery & Performance Therapy</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Gait Training, Balance Therapy & Fall Prevention</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Pediatric Physiotherapy & Developmental Support</span>
                        </li>

                        <li class="flex items-start gap-3">
                            <span class="mt-1 h-6 w-6 flex items-center justify-center rounded-full 
                 bg-[#7B3F34] text-white text-xs shrink-0">✓</span>
                            <span>Chronic Pain Management & Lifestyle Rehabilitation</span>
                        </li>
