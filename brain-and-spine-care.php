...
<body class="bg-surface-soft font-sans">
            ...
            lg:text-left lg:items-start lg:justify-center lg:container lg:mx-auto lg:px-6">
                <div class="max-w-lg">
                    ...
                    <p class="text-sm md:text-base lg:text-xl text-gray-200 leading-relaxed mt-2 lg:mt-4">
                        Our Neurosciences team provides comprehensive care for brain, spine, and nerve disorders,
                        combining advanced diagnostics, minimally invasive surgery, and multidisciplinary expertise.
                        We strive to deliver accurate evaluation, effective treatment, and long-term rehabilitation
                        for patients with neurological and neurosurgical conditions.
                    </p>
                </div>
            </div>
        </div>
  ...
  <h3 class="text-lg lg:text-xl font-semibold text-gray-900 mb-2">
    Department of <span class="text-[#f97316]">Brain & Spine Care</span>
  </h3>
  ...
  <p class="text-[13px] lg:text-[14px] leading-relaxed text-gray-700">
    ...
    effective treatment, and long-term rehabilitation for patients with complex
