   ...
   <div class="swiper mySwiper">
    ...
    <section class="flex justify-center gap-8 flex-wrap">
        ...
        <div class="w-[400px] rounded-[20px] border border-[#e4d5c6] bg-white shadow-md p-6 text-center">
            ...
            <div class="flex justify-center -mt-2">
                <div class="w-36 h-36 rounded-full bg-[#e9ecef] overflow-hidden">
                    <img src="./assets/doctors/Dr Geetha Ravindra.webp" alt="Dr Geetha Ravindra" class="w-full h-full object-cover" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 rounded-xl overflow-hidden border border-orange-500 mt-6">
                <a href="#" class="bg-[#582F28] text-white py-3 text-sm font-medium">
                    View Profile
                </a>
                <a href="#" class="bg-white text-orange-600 py-3 text-sm font-semibold">
                    Book Appointment
                </a>
            </div>
        ...
        <div class="w-[400px] rounded-[20px] border border-[#e4d5c6] bg-white shadow-md p-6 text-center">
            ...
            <div class="flex justify-center -mt-2">
                <div class="w-36 h-36 rounded-full bg-[#e9ecef] overflow-hidden">
                    <img src="./assets/doctors/Dr Amitha Hegde.webp" alt="Dr Amitha Hegde" class="w-full h-full object-cover" />
                </div>
            </div>
        ...
        <div class="w-[400px] rounded-[20px] border border-[#e4d5c6] bg-white shadow-md p-6 text-center">
            ...
            <div class="flex justify-center -mt-2">
                <div class="w-36 h-36 rounded-full bg-[#e9ecef] overflow-hidden">
                    <img src="./assets/doctors/Dr Vidya B U.webp" alt="Dr Vidya B U" class="w-full h-full object-cover" />
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <p class="text-gray-700 text-[15px] mt-1">
                    MD, Fellowship in Neonatal Neurology
                </p>
