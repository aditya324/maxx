        ...
        <div
         ...
         p-4 md:p-8 lg:p-10 bg-white text-[#4b5563] leading-12">
                <p>
                    ...
                    includes a wide range of diagnostic and therapeutic techniques used to evaluate
                    and treat heart conditions. Non-invasive methods such as ECG, Echocardiography,
                    TMT, and Holter monitoring help assess heart function without entering the body.
                    Invasive procedures like angiography and angioplasty provide detailed imaging
                    and targeted treatment for blocked or diseased arteries. At MaAx Hospital, our
                    advanced cardiac unit offers both approaches with precision, ensuring accurate
                    diagnosis, timely intervention, and comprehensive cardiovascular care.
                </p>
            </div>
